...
class Order(models.Model):
    ...
    owner = models.ForeignKey(costumer,on_delete=models.SET_NULL, null=True,related_name='orders')
    delete_stutas = models.IntegerField(choices=DELETE_CHOICES,default=LIVE)
